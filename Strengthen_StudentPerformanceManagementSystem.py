...
"""
#Stu.json
{"kiki": {"Chinese": 90, "Math": 98, "English": 100}, "mo":{"Chinese":99,"Math":95,"English":96}}
"""


import json

with open('Stu.json','rt',encoding='utf-8') as f:
    stu_dic = json.load(f)  # 读取
...
class DeleteData:
    ...
    def delete(self):
        ...
        with open('Stu.json','wt',encoding='utf-8') as f:
            json.dump(stu_dic,f)
